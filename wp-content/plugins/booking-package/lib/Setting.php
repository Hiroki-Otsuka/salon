<?php
    ...
    class booking_package_setting {
        ...
        public $email_message = array(
            "mail_new_admin" => array("key" => "mail_new_admin", "subject" => "", "content" => "", 'enable' => '0', 'format' => 'html', 'title' => 'New', 'message' => 'Email is sending to Admin after Making of booking.'), 
            ...
            "mail_approved" => array("key" => "mail_approved", "subject" => "", "content" => "", 'enable' => '0', 'format' => 'html', 'title' => 'Approved', 'message' => 'Email is sending to visitor after Approval of booking.'),
            "mail_pending" => array("key" => "mail_pending", "subject" => "", "content" => "", 'enable' => '0', 'format' => 'html', 'title' => 'Pending', 'message' => 'Email is sending to Visitor after Booking set as Pending.'),
            "mail_reminder" => array("key" => "mail_reminder", "subject" => "", "content" => "", 'enable' => '0', 'format' => 'html', 'title' => 'Reminder', 'message' => 'Email is sending to Visitor after Booking set as Pending.'),
            ...
            "mail_canceled_by_visitor_user" => array("key" => "mail_canceled_by_visitor_user", "subject" => "", "content" => "", 'enable' => '0', 'format' => 'html', 'title' => 'Canceled', 'message' => 'Email is sending to visitor or user after Cancellation of booking.'),
            "mail_deleted" => array("key" => "mail_deleted", "subject" => "", "content" => "", 'enable' => '0', 'format' => 'html', 'title' => 'Deleted', 'message' => 'Email is sending to Visitor after Deletion of booking.'),
        );
        ...
        **/
                ...
                if (is_null($row)) {
                    ...
                    $wpdb->insert(
                        ...
                        array(
                            ...
                            'content' => balanceTags(wp_kses_post($messages[$key]['content'])),
                            'subjectForAdmin' => sanitize_text_field($messages[$key]['subjectForAdmin']),
                            'contentForAdmin' => balanceTags(wp_kses_post($messages[$key]['content'])),
                            'format' => 'text',
                        ), 
        ...
        public function getElementForCalendarAccount(){
            ...
            $calendarAccount = array(
                ...
                'status' => array('key' => 'status', 'name' => 'Calendar status', 'target' => 'both', 'value' => 'open', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 0, 'option' => 0, 'valueList' => array('open' => __('Open', $this->pluginName), 'close' => __('Closed', $this->pluginName))),
                ...
                **/
                ...
                /**
                'bookingVerificationCode' => array('key' => 'bookingVerificationCode', 'name' => __('Send a booking verification code to visitor', $this->pluginName), 'target' => 'both', 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 1, 'option' => 0, 'valueList' => array('emailAndSms' => __('Enabled', $this->pluginName) . ' - ' . __('Email and SMS', $this->pluginName), 'email' => __('Enabled', $this->pluginName) . ' - ' . __('Email', $this->pluginName), 'sms' => __('Enabled', $this->pluginName) . ' - ' . __('SMS', $this->pluginName), 'false' => 'Disabled')),
                'bookingVerificationCodeToUser' => array('key' => 'bookingVerificationCodeToUser', 'name' => __('Send a booking verification code to user', $this->pluginName), 'target' => 'both', 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 1, 'option' => 0, 'valueList' => array('emailAndSms' => __('Enabled', $this->pluginName) . ' - ' . __('Email and SMS', $this->pluginName), 'email' => __('Enabled', $this->pluginName) . ' - ' . __('Email', $this->pluginName), 'sms' => __('Enabled', $this->pluginName) . ' - ' . __('SMS', $this->pluginName), 'false' => 'Disabled')),
                **/
                ...
                **/
                'bookingReminder' => array('key' => 'bookingReminder', 'name' => __('Booking reminder', $this->pluginName), 'target' => 'day', 'disabled' => 0, 'value' => '0', 'inputLimit' => 1, 'inputType' => 'SELECT', 'isExtensionsValid' => 1, 'option' => 0, 
                    'valueList' => array(
        ...
        public function getFormInputType(){
            ...
            $formInputType = array(
                ...
                'targetCustomers' => array('key' => 'targetCustomers', 'name' => __('Target customers', $this->pluginName), 'value' => 'customers', 'inputLimit' => 1, 'inputType' => 'RADIO', 'valueList' => array('customersAndUsers' => __('Visitors and Users', $this->pluginName), 'visitors' => __('Visitors', $this->pluginName), 'users' => __('Users', $this->pluginName)), "class" => ""),
                'type' => array('key' => 'type', 'name' => 'Type', 'value' => 'TEXT', 'inputLimit' => 1, 'inputType' => 'SELECT', 'valueList' => array('TEXT' => 'TEXT', 'SELECT' => 'SELECT', 'CHECK' => 'CHECK', 'RADIO' => 'RADIO', 'TEXTAREA' => 'TEXTAREA'), "class" => ""),
